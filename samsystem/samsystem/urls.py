...
urlpatterns = [
    ...
    # Report routes
    path('student/report/', views.student_report, name='student_report_overview'),  # For general report
    path('student/report/<int:pk>/', views.student_report, name='student_report'),  # For specific student report
